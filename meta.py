...
try:
    ...
    SQLALCHEMY_DATABASE_URL = os.environ['DATABASE_URL']  ## because databse must be postgresql:  not  postgres:
    SQLALCHEMY_DATABASE_URI = 'postgresql://' + SQLALCHEMY_DATABASE_URL.split('://')[1]
